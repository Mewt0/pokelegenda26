...
class Itemsinpage{
	...
	function __construct($total){
		...
		$_GET['count'] = $this->inpage = 15;
		$this->totalpages = ceil($total/$this->inpage);
		// Немного увеличим количество ссылок для удобства навигации при большом количестве страниц!
		$this->linkcount= 25; // Такое количество выбрано для удобства!
