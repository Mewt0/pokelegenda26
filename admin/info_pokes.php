...
<title>Pokelegenda -> Информация о покемоне: <?php print $_GET['id_pokem'];?></title>
</head>
<table align="center" border="1">
<tr>
<td>
<font color=Snow>Поиск по ид покемона:</font>
...
if(!$varsPokes){ 
 ...
 if($varsPokes['startone'] == 2){
    echo "<font color=gold><b>Просмотр покемона ID: ".$messages['id']." ограничен Администратором.</b></font>";
  } else {    
