...
if(!empty($_GET['quest_npc']) && !empty($_GET['do']) && $_GET['quest_npc'] == 1){
  ...
  if(!empty($_GET['npc']) && ($_GET['npc'] == 1 || $_GET['npc'] == 2 || $_GET['npc'] == 3)){
    ...
    $move = '<a href="/game.php?go=charWork&loc=107" target="_chat_two">Полицейский участок</a> | <a href="/game.php?go=charWork&loc=103" target="_chat_two">Дорога 101</a> | <a href="/game.php?go=charWork&loc=105" target="_chat_two">Дорога 102</a> | <a href="/game.php?go=charWork&loc=106" target="_chat_two">Дорога 103</a> ';
