<?php  
  if(!empty($_GET['npc']) && ($_GET['npc'] == 1 || $_GET['npc'] == 2)){
    ...
    $move = '<a href="/game.php?go=charWork&loc=53" target="_chat_two">Дорога 8</a> | <a href="/game.php?go=charWork&loc=59" target="_chat_two">Дорога 11</a> | <a href="/game.php?go=charWork&loc=60" target="_chat_two">Пещера Диглетов</a>';
  }
?>