...
function attac_battle($id,$zap){ 
 ...
 if($id == 999 && $zap == 'atac_name') $a = ' Замена покемона ';
 if($id == 998 && $zap == 'atac_name') $a = ' Использование итема ';
 return $a;
}
...
function tittleAttak($id){
   $tittle = array();
   $tittle[13]  = ' и подготавливается нанести атаку ';
   $tittle[19]  = ' взлетает высоко в небо и подготавливается нанести атаку ';
   $tittle[76]  = ' накапливает солнечную энергию и подготавливается нанести атаку ';
   $tittle[91]  = ' зарывается под землю и подготавливается нанести атаку ';
   $tittle[143] = ' и подготавливается нанести атаку ';
   $tittle[248] = ' и начинает подготавливаться нанести атаку ';
   $tittle[291] = ' ныряет под воду и подготавливается нанести атаку ';
   $tittle[340] = ' и начинает подготавливаться нанести атаку ';
   $tittle[353] = ' и начинает подготавливаться нанести атаку ';
   $tittle[467] = ' становится невидимым и начинает подготавливаться нанести атаку ';
   $tittle[553] = ' накапливает энергию и подготавливается нанести атаку ';
   $tittle[554] = ' накапливает энергию и подготавливается нанести атаку ';
 return $tittle[$id];
}
...
function hpmy_go($id,$poke,$battle)
{
  switch ($id):  
    case 208:             
      ...
      $dm_mess = " Milk Drink восстанавливает половину максимальной HP #".poke_info($poke,'names'); 
    break;
    ...
    case 234:
      ...
      $dm_mess = " Morning Sun восстанавливает HP #".poke_info($poke,'names')."($h_tittle от максимума)"; 
    break;
    ...
    case 235:     
      ...
      $hp_my_pl = round(poke_info($poke,'hp_max')*$h);  
      $dm_mess = " Synthesis восстанавливает HP #".poke_info($poke,'names')."($h_tittle от максимума)"; 
    break;
    ...
    case 236:
      ...
      $hp_my_pl = round(poke_info($poke,'hp_max')*$h);  
      $dm_mess = " Moonlight восстанавливает HP #".poke_info($poke,'names')."($h_tittle от максимума)"; 
    break;
    
    case 303:
      $hp_my_pl = round(poke_info($poke,'hp_max')*0.5);   
      $dm_mess = " Slack Off восстанавливает половину максимальной HP #".poke_info($poke,'names'); 
    break;
  endswitch;
...
function items_go_pokes($poke_xod,$battle){
     ...
     if($item == 3 && infoBattle($battle,'batl_tip') == 'pve' && poke_info($p2,'poimka') == 1){     
         ...
         if($pokeball == false){
            $r = rand(1,2);
            if($r == 1) $message = users($users,'login').", использует: Покебол, но промахивается ";
             else $message = users($users,'login').", использует: Покебол, но #".poke_info($p2,'names')." не хочет залазить в него ";
          }else{
            ...
            die('<script>alert("Покемон успешно пойман");location.href=\'/game.php?go=char\';</script>');
          }
     }
   if ($item == 15) {                  
    delete('bttle_status', 'pokeid="' . mysql_real_escape_string($poke_xod, $connect) . '" AND namber_st=2');
    $message = users($users, 'login') . ", использует: Энергетик, на: #" . poke_info($poke_xod, 'names');
}
    if($item == 91){
       $h = poke_info($poke_xod,'hp_my') + 20; 
       if($h > poke_info($poke_xod,'hp_max')) $h = poke_info($poke_xod,'hp_max'); 
       updateHp($poke_xod, $h);
       $message = users($users,'login').", использует: Зелье, на: #".poke_info($poke_xod,'names');
    }
if($item == 93){
    $h = poke_info($poke_xod, 'hp_max');
    $a = "";

    // Безпечне екранування без підключення до БД
    $escaped_pokeid = addslashes($poke_xod);

    if(rand(1,100) <= 50) {
        delete('bttle_status', 'pokeid="' . $escaped_pokeid . '"');
        $a = ", а так же снимает статус болезни";
    }

    updateHp($poke_xod, $h);
    $message = users($users, 'login') . ", использует: Зелье восстановления, на: #" . poke_info($poke_xod, 'names') . " и полоностью восстанавливает его здоровье" . $a;
}

// Заглушка: временно не удаляем предмет
...
function stat_no_pok($id,$p,$battle) {
  switch ($id):  
    case 39:
      ...
      $speed = "0";
      $tip_s = "minus";
      $mess = ' [Защита #'.poke_info($p,'names').' понижена на 1 пункт]';
    break;    
    case 43:
      $def = "1"; 
      $atc = "0"; 
    ...
    case 45:
      ...
      $speed = "0";
      $tip_s = "minus";
      $mess = ' [Атака #'.poke_info($p,'names').' понижена на 1 пункт]';
    break;    
    case 103:
      $def = "2"; 
      $atc = "0"; 
      ...
      $speed = "0";
      $tip_s = "minus";
      $mess = ' [Защита #'.poke_info($p,'names').' понижена на 2 пункта]';
    break;
    case 297:
      $def = "0"; 
      $atc = "2"; 
      ...
      $speed = "0";
      $tip_s = "minus";
      $mess = ' [Атака #'.poke_info($p,'names').' понижена на 2 пункта]';
    break;    
    case 313:
      $def = "0"; 
      $atc = "0"; 
      ...
      $speed = "0";
      $tip_s = "minus";
      $mess = ' [Спец. Защита #'.poke_info($p,'names').' понижена на 2 пункта]';
    break;
    case 319:
      $def = "0"; 
      $atc = "0"; 
...
function stat_gous_pok($id,$p,$battle){ 
  ...
  $a   = first('SELECT * FROM stat_attak WHERE id_atk=%d',$id);
    if($a['tip'] == "plus"){
      ...
      $accuracy  = $a['accuracy']; 
      $tip_s     = "plus";
        if($def > 0)        $at .= " [Защита на +".$def."] ";
        if($atc > 0)        $at .= " [Атака на +".$atc."] ";
        if($acc > 0)        $at .= " [Ловкость на +".$acc."] ";
        if($sdef > 0)       $at .= " [Спец. Защита на +".$sdef."] ";
        if($satc > 0)       $at .= " [Спец. Атака на +".$satc."] ";
        if($speed > 0)      $at .= " [Скорость на +".$speed."] ";
        if($accuracy > 0)   $at .= " [Точность на +".$accuracy."] ";
      $bt = "<br><font color='gold'>У #".poke_info($p,'names')." увеличено: </font><br>".$at;
    ...
    if($a['tip_b'] == "minus"){
      ...
      $tip_s      = "minus";
        if($def > 0)        $at2 .= " [Защита на -".$def."] ";
        if($atc > 0)        $at2 .= " [Атака на -".$atc."] ";
        if($acc > 0)        $at2 .= " [Ловкость на -".$acc."] ";
        if($sdef > 0)       $at2 .= " [Спец. Защита на -".$sdef."] ";
        if($satc > 0)       $at2 .= " [Спец. Атака на -".$satc."] ";
        if($speed > 0)      $at2 .= " [Скорость на -".$speed."] ";
        if($accuracy > 0)   $at2 .= " [Точность на -".$accuracy."] ";
      $bt .= " <br><font color='gold'>У #".poke_info($p,'names')." уменьшено: </font><br>".$at2;
     stats_insert($p,$battle,$def,$atc,$sdef,$satc,$speed,$acc,$accuracy,$tip_s);
    }
  $mess = ". ".$bt;
 return $mess;
    ...
    $namber_st_yes = $status_yes['namber_st'];
      switch ($namber_st_yes):  
        case 1:
          ...
          $mess = ', яд отнимает здоровье у #'.poke_info($p,'names');
          $resultatic = 1;
          $ok = 1; 
        break;
        case 2:
        ...
        case 3:     
          $hp_up = round(poke_info($p,'hp_max')/8);
          $mess = ', огонь ослабляет #'.poke_info($p,'names');
          $resultatic = 1;
          $ok = 1; 
        break;
        case 4:
        ...
        case 8:
          $hp_up = round(poke_info($p,'hp_max')/8);        
          $mess = ', растения-пиявки отнимают здоровье у #'.poke_info($p,'names');
          $resultatic = 1;
          $ok = 1; 
        break;
        case 9:
          $hp_up = round(poke_info($p,'hp_max')/4);        
          $mess = ', #'.poke_info($p,'names').' теряет часть своего здоровья, так как он проклят';
          $resultatic = 1;
          $ok = 1; 
        break;
      endswitch;
...
function status_go($namber_status,$pokemon,$battle){
  ...
  $update = false;
    switch ($namber_status):  
      case 1:
        ...
        $number_st = 1;
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Отравлен</b>]'; 
      break;
      case 2:
        $ran       = ''.mt_rand(2,5);
        $random    = infoBattle($battle,'raund') + $ran; 
        $number_st = 2;
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Усыплен</b>]';
      break;
      case 3:
        $ran       = ''.mt_rand(9999,99999);
        $random    = infoBattle($battle,'raund') + $ran;  
        $number_st = 3;
        $mess3     = ', [#'.poke_info($pokemon,'names').' в огне, так же его атака понижена на 2 пункта]';
        $st_stat   = 1; 
        $atc       = "2"; 
        $tip_s     = "minus";
      break;
      case 4:
        ...
        $random    = infoBattle($battle,'raund') + $ran;  
        $number_st = 4;
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Заморожен</b>]';
      break;
      case 5:
        $ran       = ''.mt_rand(9999,99999);
        $random    = infoBattle($battle,'raund') + $ran;  
        ...
        $speed     = "4"; 
        $tip_s     = "minus";
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Парализован</b>, так же его скорость понижена на 4 пункта]';
      break;
      case 6:
        $ran       = 1;
        $random    = infoBattle($battle,'raund') + $ran; 
        $number_st = 6;
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Напуган</b>]'; 
      break;
      case 7:
        $ran       = ''.mt_rand(9999,99999);
        $random    = infoBattle($battle,'raund') + $ran; 
        $number_st = 7;
        $mess3     = ' [#'.poke_info($pokemon,'names').' <b>Спутан</b>]';
      break;
      case 8:
        $ran       = ''.mt_rand(9999,99999);
        $random    = infoBattle($battle,'raund') + $ran; 
        $number_st = 8;
        $mess3     = ' [На #'.poke_info($pokemon,'names').' <b>Наложены растения-пиявки</b>]';
      break;
      case 9:
        $ran       = ''.mt_rand(9999,99999);
        $random    = infoBattle($battle,'raund') + $ran; 
        $number_st = 9;
        $mess3     = ' [На #'.poke_info($pokemon,'names').' <b>Проклят</b>]';
        $update    = true;
      break;
      case 777:
        $ran       = ''.mt_rand(2,2);
  ...
  $status_yes = first('SELECT id_sts FROM bttle_status WHERE buttleid=%d AND pokeid="%s"',$battle,$pokemon);  
    ...
    elseif($status_yes AND $update == true)
      ...
      $mess3 = " [Cостояние: #".poke_info($pokemon,'names')." не может быть изменено]";  $ok_stat = "0";
    }
...
function new_propusc($p, $battle, $atk){
  ...
  if(attac_battle($atk,'dop_effect') == "propusk"){
    if ($id_atk == 63 OR $id_atk == 307 OR $id_atk == 338 OR $id_atk == 416){                                                     
      $mes_a = " но восстанавливает силы после: <a href=javascript: onClick=win1=window.open('/game.php?go=atk&id=".$id_atk."','atk','width=726,height=260,scrollbars=yes');return true;>".attac_battle($atk,'atac_name')."</a>";
      $cols = 2;
          ...
          if(poke_info($pokemon,'hp_my') > 0){
            ...
            /*** Генерация/Обработка - удара ***/
              ...
              if($status_my['resultatic'] == 1 || $status_my['resultatic'] == 6){
               if($status_my['resultatic'] == 1){
                if(battle_dop($pokemonEnemy,'vulnerability',$idBattle) == 1 && attac_battle($pokemonAttak,'dop_effect') != 2){ 
                  $txtObr = " но #".poke_info($pokemonEnemy,'names')." не доступен для атак ";
                  $udarTrue = 'other'; 
                  $ok = false; 
                }
                ...
                if($pokemonEnemyAttak == 182 || $pokemonEnemyAttak == 197){
                  $txtObr = " но #".poke_info($pokemonEnemy,'names')." защитил себя от атаки ";
                  $udarTrue = 'other';
                  $pp_up = 1;  
                  $ok = false;        
                } 
                if((attac_battle($pokemonAttak,'dop_effect') == "dopropusk") && ($array_propusk['hod'] == false) && ($array_propusk['attac'] == false)){  
                  ...
                  $udarTrue = 'other';
                  $txtObr = " но он ".$status_my['mess_status'];
              }
              ...
              if($pokemonAttak == "999" && $ok == true && $smena == 1){
                ...
                $txtObr = "<b>".users(poke_info($cb[$c],'users'),'login')."</b>, заменяет покемона на: #".poke_info($cb[$c],'names')."";
                $ok = false;
                $goPokemon = true; 
                $zamena = "1";
                $pp_up = 0;
              ...
              if($ok == 0 && $zamena != 1){
                if($status_my['hp_up'] != false) {
                  ...
                  if($rs_hp_my <= 0) $txtObr .= ", он больше не может продолжать бой!";
                }
              }
            if($ok == 1){        
            ...
            if($goPokemon == false){
            if($ok == true){ 
             /** Узнаем тип атаки, сравнивам с типом покеомнов, выдаем результат. **/
              ...
              $tip_res = $typesAttac['1']*$typesAttac['2']; // Умноножаем типы.
             /** -END- **/
            }
            if($status_my['resultatic'] == 1 OR $status_my['resultatic'] == 6){
              $lupe = round(attac_battle($pokemonAttak,'atac_accuracy'));        
                if($lupe == 0 OR $lupe == false) $lupe_res = 9999;
                    ...
                    $pl_user    = stat_struc($pokemon,'accuracy','plus',  $idBattle); // Точность
                    $min_user   = stat_struc($pokemon,'accuracy','minus', $idBattle); // Точность
                    $pl_nouser  = stat_struc($pokemonEnemy, 'acc','plus', $idBattle); // Ловоксть
                    $min_nouser = stat_struc($pokemonEnemy, 'acc','minus',$idBattle); // Ловоксть
                    $item_my = "0";
                    $item_no = "0";
                ...
                if(rand(1,100) <= $lupe_res){
                  $pp_up = 1;
                    if(attac_battle($pokemonAttak,'atac_categori') == 1 OR attac_battle($pokemonAttak,'atac_categori') == 2){
                      $crit = 1*attac_battle($pokemonAttak,'critic'); /** Крит удрар **/
                      $randomnumber = ''.mt_rand(85,100); /** Рандомный номер **/
                        if($tip_res > 0){
                          ...
                          if(rand(1,100) <= $crit){
                            $crit_udar = 2; 
                            $crt_mess  = ", <font color=gold><i>КРИТИЧЕСКИЙ УДАР!</i></font>"; 
                          }else{
                            $crit_udar = 1;
                            $crt_mess  = "";
                          }
                           ...
                           elseif($pokemonAttak == 217){
                              $hd = rand(1,50);
                                ...
                                elseif($hd < 10 && $hd > 1) { 
                                  $hp_ot_uron = 80; 
                                  $ok_demag = 0; 
                                  $dm_mess_e = ", восстанавливает НР #".poke_info($pokemon,'names')." на 80 едениц "; 
                                }
                                else $power_atak = 20;    
                              $ok_dm = 0;
                           }
                        ...
                        if($ok_demag == 1){
                          ...
                          if($status_my['resultatic'] != 6){
                                if ($tip_res == 0)    $dm_mess_e = ", но эффекта нет";  
                            elseif ($tip_res == 2)    $dm_mess_e = ", Эффективная атака"; 
                            elseif ($tip_res == 4)    $dm_mess_e = ", Очень эффективная атака"; 
                            elseif ($tip_res == 0.5)  $dm_mess_e = ", Слабый эффект от атаки"; 
                            elseif ($tip_res == 0.25) $dm_mess_e = ", Очень слабый эффект от атаки";
                            ...
                            if($otdacha_hp > 0) $dm_mess_e .= " , #".poke_info($pokemon,'names')." получил отдачу от нанесенного урона "; 
                              updateHp($pokemonEnemy, $rs_hp);
                            if($tip_res != 0) $t_ur = "и наносит урон: ".$dm;
                            if($rs_hp <= 0) $hp_pr = ", #".poke_info($pokemonEnemy,'names')." больше не может продолжать битву";
                          }else{
                            $rs_hp = (round($dm/6));
                            $sput_udar = ($rs_hp<=0?0:$rs_hp);
                            $t_ur = " ударяет себя, так как он ";
                            $crt_mess = "";
                            $stabs = "";
                            $dm_mess_e = "";
                          } 
                        ...
                        $hp_attacers_min = "0";
                          if($pokemonAttak == 71){
                             ...
                             $stabs  .=  ", Absorb восстанавливает HP: #".poke_info($pokemon,'names')." на половину от потерянного ";
                          }
                          elseif($pokemonAttak == 72){
                             $hp_attacers = round($dm/2);
                             $stabs  .=  ", Mega Drain восстанавливает HP: #".poke_info($pokemon,'names')." на половину от потерянного ";
                          }
                          elseif($pokemonAttak == 72){
                             $hp_attacers = round($dm/2);
                             $stabs  .=  ", Mega Drain восстанавливает HP: #".poke_info($pokemon,'names')." на половину от потерянного ";
                          ...
                          elseif($pokemonAttak == 141){
                             $hp_attacers = round($dm/2);
                             $stabs  .=  ", Leech Life восстанавливает HP: #".poke_info($pokemon,'names')." на половину от потерянного ";
                          }
                          elseif($pokemonAttak == 202){
                             $hp_attacers = round($dm/2);
                             $stabs  .=  ", Giga Drain восстанавливает HP: #".poke_info($pokemon,'names')." на половину от потерянного ";
                          }
                              ...
                              if(rand(1,100) <= $canse_dop){
                                $zap_a = first('SELECT * FROM attac_dop WHERE id_attc=%d',$pokemonAttak);
                                  ...
                                  if(($zap_a['setting'] == 2) OR ($zap_a['setting'] == 3)){                                                                                                                
                                      ...
                                      if($zap_a['tip_s'] == "minus") $zap_m = ", уменьшено: ";
                                        else  $zap_m = ", у: #".poke_info($p,'names')." увеличено: ";
                                      if($zap_a['def']>0)        $zap_m .= " [Защита] ";
                                      if($zap_a['atc']>0)        $zap_m .= " [Атака] ";
                                      if($zap_a['acc']>0)        $zap_m .= " [Ловкость] ";
                                      if($zap_a['sdef']>0)       $zap_m .= " [Спец. Защта] ";
                                      if($zap_a['satc']>0)       $zap_m .= " [Спец. Атака] ";
                                      if($zap_a['speed']>0)      $zap_m .= " [Скорость] ";
                                      if($zap_a['accuracy']>0)   $zap_m .= " [Точность] ";
                                  }
                      ...
                      if($tip_res > 0){ 
                        ...
                        if($attac_not > 0){ 
                          if($attac_not == 8 && ($pokemonEnemy_tipe_one == 'Grass' || $pokemonEnemy_tipe_two == 'Grass')) $t_ur = " провал";
                           else
                      ...
                      if(attac_battle($pokemonAttak,'attac_effecti') == 2){
                        if($pokemonAttak == 105){
                          ...
                          $stabs  .=  ", восстанавливает 1/2 от масимального HP: #".poke_info($pokemon,'names')." ";
                        }
                        ...
                        elseif($pokemonAttak == 187){
                          ...
                          $stabs  .=  "<br>[HP: #".poke_info($pokemon,'names')." уменьшено в 2 раза] ";
                        } 
    ...
    if (rand(1, 100) <= $canse_dop) {
        ...
        if ($zap_a) {
            ...
            if ($zap_a['setting'] == 2) {
                ...
                $zap_m = ($zap_a['tip_s'] == "minus") ? ", уменьшено: " : ", увеличено: ";

                if ($zap_a['def'] > 0)      $zap_m .= " [Защита] ";
                if ($zap_a['atc'] > 0)      $zap_m .= " [Атака] ";
                if ($zap_a['acc'] > 0)      $zap_m .= " [Ловкость] ";
                if ($zap_a['sdef'] > 0)     $zap_m .= " [Спец. Защита] ";
                if ($zap_a['satc'] > 0)     $zap_m .= " [Спец. Атака] ";
                if ($zap_a['speed'] > 0)    $zap_m .= " [Скорость] ";
                if ($zap_a['accuracy'] > 0) $zap_m .= " [Точность] ";
            }
...
// Дополнение у статусной атаки *конец*
                      // Дополнение у статусной атаки *конец*
                    }
                    $status_hp = 0;
                    $attac_hp = 0;       
                    if($status_my['hp_up'] != false){  
                      ...
                      if($status_my['id_status'] == 8 && $poInf > 0){
                         ...
                         $status_my['mess_status'] = $status_my['mess_status'].'. [Растения пиявки восстанавливают HP: '.poke_info($pokemonEnemy,'names').']';
                      }
                      $status_hp = $status_my['hp_up'];
                    }
                    ...
                    $rs_hp_my = round((poke_info($pokemon,'hp_my') - $status_hp - $sput_udar - $hp_attacers_min - $otdacha_hp) + $attac_hp + $hp_attacers + $hp_ot_uron);
                     ...
                     if($pokemonAttak == 156){
                        ...
                        $t_ur .= " Полностью восстанавливает HP: #".poke_info($pokemon,'names').", ";
                        $t_ur .= status_go(777,$pokemon,$idBattle);
                     }
                     if($pokemonAttak == 18 || $pokemonAttak == 46){
                         if(infoBattle($idBattle,'batl_tip') == 'pvp'){  
                             $ok_demag = false;
                             if($pokemon == infoBattle($idBattle,'poke_1')) { $сompu = 'zamtru_2'; } else { $сompu = 'zamtru_1'; }
                             ...
                             if($counPokeActiv['countpok'] > 1){
                              ...
                              update('battles',array($сompu=>1),'id='.(int)$idBattle);
                              $uronNoBase  = ' и вынуждает тренера: '.$users.' сменить покемона ';
                            }else{
                              $uronNoBase  = ' провал ';
                           }
                         }else{
                     ...
                     if($pokemonAttak == 369 || $pokemonAttak == 521){
                       if(infoBattle($idBattle,'batl_tip') == 'pvp'){ 
                           if($pokemon == infoBattle($idBattle,'poke_1')) { $сompu = 'zamtru_1'; } else { $сompu = 'zamtru_2'; }
                           $uInf = poke_info($pokemon,'users');
                           $counPokeActiv  = first('SELECT COUNT(*) as countpok FROM pok_user WHERE users=%d AND active=1 AND hp_my>0',$uInf);
                           if($counPokeActiv['countpok'] > 1){
                            $users =  users($uInf,'login');    
                            update('battles',array($сompu=>1),'id='.(int)$idBattle);
                            $uronNoBase  = ', а так же вынуждает тренера: '.$users.' сменить покемона ';
                          }else{
                            $uronNoBase  = false;
                          }
                       }else{
                    ...
                    if($pokemonAttak == 174){
                        if($pokemonMy_tipe_one == 'Ghost' || $pokemonMy_tipe_two == 'Ghost'){
                         $uronNoBase = status_go(9,$pokemonEnemy,$idBattle).', #'.poke_info($pokemon,'names').' теряет часть своего здоровья '; 
                         $rs_hp_my = $rs_hp_my - poke_info($pokemon,'hp_max')*0.5;
                           ...
                           $uronNoBase = ' у #'.poke_info($pokemon,'names').' увеличено: [Атака +1], [Защита +1] и уменьшено: [Скорость -1] '; 
                        }
                    }
                    $rs_hp_my = ($rs_hp_my<=0?0:$rs_hp_my);
                    if($rs_hp_my > poke_info($pokemon,'hp_max')) $rs_hp_my = poke_info($pokemon,'hp_max');
                      updateHp($pokemon, $rs_hp_my);
                    if($rs_hp_my <= 0) $hp_no = ", больше не может продолжать бой";
            ...
            $trxtPovtor       = "<img src='pok/anim/".$infoPokesBasenum.".".img($infoPokesBasenum)."' onClick=win1=window.open('/game.php?go=pokedex&id=".$infoPokesBasenum."','pokedex','width=550,height=550,scrollbars=yes');return true;> 
                                  #".$infoPokesName." использует атаку:  
            ...
            elseif($udarTrue == 'promax'){
               $txtObr = $trxtPovtor." но промахивается";
               $pp_up = "1";
               if(attac_battle($pokemonAttak,'dop_effect') == "propusk") new_propusc($pokemon, $idBattle, $pokemonAttak);
            }
            elseif($udarTrue == 'status'){
               $txtObr = $trxtPovtor." но ".$status_my['mess_status'];
            }
            elseif($udarTrue == 'nohp'){
               $txtObr = $trxtPovtor." но не может продолжать бой";
            }
