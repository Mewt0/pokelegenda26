...
?>
<html>
<TITLE>League-Of-Pokemons -> Выставить предмет на продажу</TITLE>
<head>
<style>
BODY {
	 color: #000;
...
<form action="game.php?go=rinok&post" method="post">
  ...
  <tr align="center">
    <td COLSPAN=4 align=center>
      <input type="submit" name="submit" value="Выставить на продажу"> 
    </td>
  </tr>
</form>';
}
foreach($eggMy as $eggMyRow){
  $egg_name = "Яйцо: #".$eggMyRow['title'];
  $content  = timersOtshet($eggMyRow['dtime'],"<br>До вылупления осталось: ", "<b>Готово к вылуплению</b>");
