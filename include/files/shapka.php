...
if (isset($_GET['go']) && in_array($_GET['go'], $__GAME_UI_ROUTES, true)) {
  ...
  if (!defined('POKE_GAME_UI')) {
    ...
    |  <button type="button" class="btInp" onclick="window.open(\'/game\',\'mir\');">В мир</button>
          ...
          <table class="hmenu">
            <tbody>
              <tr class="hmenu">
                ...
                <td class="hmenu">
                  <ul id="nav">
                    <li class="top"><a href="/game" class="top_link" target="_blank"><span class="down" style="color:red">В мир!</span></a></li>
