...
<br><p><br><br>
		  ...
		  <div style='width:<?php echo $h2?>%;background:<?php echo $color2?>height:14; border: 2px solid black; border-radius: 4px;' title="Количество здоровья покемона">
    ...
    $acr_st_no_pl  = status_na_pokemone($pokem_two,$battlPve['id'],'plus','accuracy');
             if ($def_st_no_pl>0) echo "<b>Защита + ".$def_st_no_pl."</b> ";
             if ($sdef_st_no_pl>0)echo "<b>Спец. Защита + ".$sdef_st_no_pl."</b> ";
             if ($atk_st_no_pl>0) echo "<b>Атака + ".$atk_st_no_pl."</b> ";
             if ($satk_st_no_pl>0)echo "<b>Спец. Атака + ".$satk_st_no_pl."</b> ";
             if ($acc_st_no_pl>0) echo "<b>Ловкость + ".$acc_st_no_pl."</b> ";
             if ($spd_st_no_pl>0) echo "<b>Скорость + ".$spd_st_no_pl."</b> ";
             if ($acr_st_no_pl>0) echo "<b>Точность + ".$acr_st_no_pl."</b> ";
    ...
    $acr_st_no_min  = status_na_pokemone($pokem_two,$battlPve['id'],'minus','accuracy');         
             if ($def_st_no_min>0) echo "<font color='".$color_stst."'><b>Защита - ".$def_st_no_min."</b></font> ";
             if ($sdef_st_no_min>0)echo "<font color='".$color_stst."'><b>Спец. Защита - ".$sdef_st_no_min."</b></font> ";
             if ($atk_st_no_min>0) echo "<font color='".$color_stst."'><b>Атака - ".$atk_st_no_min."</b></font> ";
             if ($satk_st_no_min>0)echo "<font color='".$color_stst."'><b>Спец. Атака - ".$satk_st_no_min."</b></font> ";
             if ($acc_st_no_min>0) echo "<font color='".$color_stst."'><b>Ловкость - ".$acc_st_no_min."</b></font> ";
             if ($spd_st_no_min>0) echo "<font color='".$color_stst."'><b>Скорость - ".$spd_st_no_min."</b></font> ";
             if ($acr_st_no_min>0) echo "<font color='".$color_stst."'><b>Точность - ".$acr_st_no_min."</b></font> ";
    ...
    ?>  
		  ...
		  <div style='width:<?php echo $h1?>%;background:<?php echo $color1?>height:14;  border: 2px solid black; border-radius: 4px;' title="Количество здоровья покемона">
          <font style='font:11px Tahoma; color: #1C1C1C;'>
...
$acr_st_my_pl  = status_na_pokemone($pokem_one,$pve_id,'plus','accuracy');
         if ($def_st_my_pl >0) echo "<b>Защита + ".$def_st_my_pl."</b> ";
         if ($sdef_st_my_pl>0) echo "<b>Спец. Защита + ".$sdef_st_my_pl."</b> ";
         if ($atk_st_my_pl >0) echo "<b>Атака + ".$atk_st_my_pl."</b> ";
         if ($satk_st_my_pl>0) echo "<b>Спец. Атака + ".$satk_st_my_pl."</b> ";
         if ($acc_st_my_pl >0) echo "<b>Ловкость + ".$acc_st_my_pl."</b> ";
         if ($spd_st_my_pl >0) echo "<b>Скорость + ".$spd_st_my_pl."</b> ";
         if ($acr_st_my_pl >0) echo "<b>Точность + ".$acr_st_my_pl."</b> ";
...
$acr_st_my_min  = status_na_pokemone($pokem_one,$pve_id,'minus','accuracy');         
         if ($def_st_my_min>0) echo "<font color='".$color_stst."'><b>Защита - ".$def_st_my_min."</b></font> ";
         if ($sdef_st_my_min>0)echo "<font color='".$color_stst."'><b>Спец. Защита - ".$sdef_st_my_min."</b></font> ";
         if ($atk_st_my_min>0) echo "<font color='".$color_stst."'><b>Атака - ".$atk_st_my_min."</b></font> ";
         if ($satk_st_my_min>0)echo "<font color='".$color_stst."'><b>Спец. Атака - ".$satk_st_my_min."</b></font> ";
         if ($acc_st_my_min>0)echo  "<font color='".$color_stst."'><b>Ловкость - ".$acc_st_my_min."</b></font> ";
         if ($spd_st_my_min>0)echo  "<font color='".$color_stst."'><b>Скорость - ".$spd_st_my_min."</b></font> ";
         if ($acr_st_my_min>0)echo  "<font color='".$color_stst."'><b>Точность - ".$acr_st_my_min."</b></font> ";
