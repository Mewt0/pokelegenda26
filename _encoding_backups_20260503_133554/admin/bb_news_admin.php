...
?>
  ...
  Р В§Р С‘РЎРѓР В»Р С•: <b><font color="<? echo $bb_news_date_fn; ?> "> <? echo $row['date']; ?></font> </b>
  Р С’Р Р†РЎвЂљРЎР‚Р С•РЎР‚: <b><font color="<? echo $bb_news_author_fn; ?>"> <? echo $row['author']; ?></font> </b><br>
  Р СћР ВµР СР В°: <b><font color="<? echo $bb_news_subject_fn; ?>"><? echo $row['subject']; ?></font></b><br>
  <a href=game.php?go=admingo&do=news&dil_id=<? echo $row['id'] ?>>Р Р€Р Т‘Р В°Р В»Р С‘РЎвЂљРЎРЉ</a> | <a href=game.php?go=admingo&do=news&id_mess=<? echo $row['id'] ?>&tip=viewedit>Р В Р ВµР Т‘Р В°Р С”РЎвЂљР С‘РЎР‚Р С•Р Р†Р В°РЎвЂљРЎРЉ</a></font>
  </div>
  </tr></td> 
<?php 
} print '</table>'; 
