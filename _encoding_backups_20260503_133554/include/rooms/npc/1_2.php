...
if(!empty($_GET['zapStr'])){    
    ...
    if($base>0 || $lvl>0 || $spar>0 || $gen>0 || $pol>0 || $har>0) $serch = ' | <a href="javascript:" onclick="loadPokemon(1,0,0,0,0,0,0,1);" style="font-size:16px;color:gold;">Р РЋР вЂР В Р С›Р РЋР ВР СћР В¬ Р СџР С›Р ВР РЋР С™</a></small>';
      else  $serch = false;
    function obPerm($chs){
      $chs = ceil($chs);
      $chs = abs($chs);
    ...
    $data = $itemsinpage->SmartyArr();
       ...
       $stran = false;
        ...
        if($stran != false) $onestr = ' <td align="center"><b style="color:#000;font-weight:bold;">Р РЋРЎвЂљРЎР‚Р В°Р Р…Р С‘РЎвЂ Р В°:</b></td></tr><tr>
        ...
        $txtStran .= '<table width="500" style="font-weight:bold; font-size:15px;">
            <tr>
              <td align="center"><small>
                <a href="javascript:" onclick="loadPokemon(1,'.$base.','.$lvl.','.$spar.','.$gen.','.$pol.','.$har.',1);" style="font-size:16px;color:gold;">Р С›Р вЂР СњР С›Р вЂ™Р ВР СћР В¬</a></small> '.$serch.'
              </td>
              </tr>
              <tr>
  ...
  echo "<br>
        <table>
          <tr>
            <td align='center' colspan='4' style='color:#000;font-weight:bold;font-size:25px;'>
              Р СџР С•Р С‘РЎРѓР С” Р Р† Р С—Р С‘РЎвЂљР С•Р СР Р…Р С‘Р С”Р Вµ(".$itemsCount['count']."):
            </td>
          </tr>
          <tr>
            <td style='color:#000;font-weight:bold;'>
              Р вЂР В°Р В·Р С•Р Р†РЎвЂ№Р в„– Р Р…Р С•Р СР ВµРЎР‚:
            </td>
            <td>
              <select size=\"1\" id=\"pokeBase\" onchange=\"loadPokemon(1,this.value,".$lvl.",".$spar.",".$gen.",".$pol.",".$har.",1);\">
                <option value=\"0\">Р вЂ™РЎРѓР Вµ</option>
            ...
            <td>
              <select size=\"1\" id=\"pokeGen\" onchange=\"loadPokemon(1,".$base.",".$lvl.",".$spar.",".$gen.",this.value,".$har.",1);\">
                <option value=\"0\">Р вЂ™РЎРѓР Вµ</option>
                <option value=\"1\" ".($pol==1?' selected ':'').">Р СљРЎС“Р В¶РЎРѓР С”Р С•Р в„–</option>
                <option value=\"2\" ".($pol==2?' selected ':'').">Р вЂ“Р ВµР Р…РЎРѓР С”Р С‘Р в„–</option>
              </select>
            </td>
          </tr>
          <tr>
            <td style='color:#000;font-weight:bold;'>
              Р ТђР В°РЎР‚Р В°Р С”РЎвЂљР ВµРЎР‚:
            </td>
            <td>
          ...
          <tr>
            <td style='color:#000;font-weight:bold;'>
              Р В Р В°Р В·Р Р†Р ВµР Т‘Р ВµР Р…Р С‘Р Вµ:
            </td>
            <td>
              <select size=\"1\" id=\"pokeSpar\" onchange=\"loadPokemon(1,".$base.",".$lvl.",this.value,".$gen.",".$pol.",".$har.",1);\">
                <option value=\"0\">Р вЂ™РЎРѓР Вµ</option>
                <option value=\"1\" ".($spar==1?' selected ':'').">Р вЂќР С•РЎРѓРЎвЂљРЎС“Р С—Р Р…Р С•</option>
                <option value=\"2\" ".($spar==2?' selected ':'').">Р СњР ВµР Т‘Р С•РЎРѓРЎвЂљРЎС“Р С—Р Р…Р С•</option>
              </select>
            </td>
            <td style='color:#000;font-weight:bold;'>
              Р вЂњР ВµР Р…РЎвЂ№:
        ...
        ".$txtStran."
        <br><center><b><span align=center style=\"font-size:16;color:Black;\">Р СџР С•Р С”Р ВµР СР С•Р Р…РЎвЂ№ Р Р† Р С—Р С‘РЎвЂљР С•Р СР Р…Р С‘Р С”Р Вµ:</span></b></center><table>";
  if($itemsCount['count'] <=0 ) die('<span style="color:gold">Р Р€Р Р†РЎвЂ№, Р Р…Р С• Р С—Р С• Р Т‘Р В°Р Р…Р Р…Р С•Р СРЎС“ Р С”РЎР‚Р С‘РЎвЂљР ВµРЎР‚Р С‘РЎР‹ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р С•Р Р† Р Р…Р Вµ Р Р…Р В°Р в„–Р Т‘Р ВµР Р…Р С•. Р вЂ™Р С•Р В·Р СР С•Р В¶Р Р…Р С•, РЎвЂЎРЎвЂљР С• Р вЂ™Р В°РЎв‚¬ Р С—Р С‘РЎвЂљР С•Р СР Р…Р С‘Р С” Р С—РЎС“РЎРѓРЎвЂљ.</span>');
  foreach($poke_ac_two as $poke){
      $img = ($poke['basenum'] >= 494?'.png':'.gif');
    $name = str_replace('"',"&quot;",$poke['names']);
    $name = str_replace('"',"&#39;",$name);
    $inf  = "<div align=left style=\'color:#67ff00\'>Р ВР СРЎРЏ: #".$name.".<br>Lvl: ".$poke['lvl'].".";
    $inf .= "<br>Р В Р В°Р В·Р Р†Р ВµР Т‘Р ВµР Р…Р С‘Р Вµ: ".($poke['reproduction']==0?'Р вЂќР С•РЎРѓРЎвЂљРЎС“Р С—Р Р…Р С•':'Р СњР ВµР Т‘Р С•РЎРѓРЎвЂљРЎС“Р С—Р Р…Р С•').".";
    $inf .= "<br>Р ТђР В°РЎР‚Р В°Р С”РЎвЂљР ВµРЎР‚: ".haracter_pokes($poke['har']).".";
    $inf .= "<br>Р РЋРЎвЂЎР В°РЎРѓРЎвЂљРЎРЉР Вµ: ".$poke['happy']."%.";
    $inf .= "<br>Р СџР С•Р В»: ".($poke['sex']==1?'Р Сљ':'Р вЂ“').".";
    $inf .= "<br>Р вЂњР ВµР Р…Р С•Р С”Р С•Р Т‘: HP-".$poke['hp_iv'].", AT-".$poke['atk_iv'].", DF-".$poke['def_iv'].", SA-".$poke['satk_iv'].", SD-".$poke['sdef_iv'].", SP-".$poke['speed_iv'].".<br>ID: ".$poke['id'].".</div>";
    $inf .= "<a href=\'game.php?go=char&npc=1&do_npc=2&pitomnik=1&id=".$poke['id']."&do=1".$sbornik."\' target=\'_chat_two\' style=\'color:gold;\' onclick=parent.mess_error(\'false\',\'none\');>->Р вЂ”Р В°Р В±РЎР‚Р В°РЎвЂљРЎРЉ Р С‘Р В· Р С—Р С‘РЎвЂљР С•Р СР Р…Р С‘Р С”Р В°<-</a>";
    echo "
      <tr>
        <td>
        ...
        <td>ID: ".$poke['id']."</td>
        <td>          
          <a href='javascript:' onclick=\"parent.mess_error('".$inf."','block');\" style='color:gold;'>-Р С‘Р Р…РЎвЂћ-</a>
        </td>
      </tr>";
    }
  echo "</table></center>";
...
function loadPokemon(strn,valueBase,levels,spar,gen,pol,har,tip){
 $("#load").html('Р РЋР С•РЎРѓРЎвЂљР С•РЎРЏР Р…Р С‘Р Вµ: <img src="/css/img/load.gif" alt="Р вЂ”Р В°Р С–РЎР‚РЎС“Р В·Р С”Р В°" border="0"/>');
  if(tip == 1){
    ...
    $.ajax({  
      ...
      success: function(txt){
         $("#pitomnik").html(txt);
         $("#load").html("Р РЋР С•РЎРѓРЎвЂљР С•РЎРЏР Р…Р С‘Р Вµ: OK.");
...
<div id="fixedWindow" align="center">
  <b><span align=center style="font-size:20;color:Black;">Р СџР С‘РЎвЂљР С•Р СР Р…Р С‘Р С” Р С–Р С•РЎР‚Р С•Р Т‘Р В°: <br> 
  <?php 
  $nameBuildQ = buildInf($myrow['buildmy'],'title');
  $rest = substr($nameBuildQ, -1);
  if($rest === 'РЎРЏ') $nameBuild = substr($nameBuildQ, 0, -1).'Р С‘';
  else $nameBuild = $nameBuildQ.'Р В°';
  if($nameBuildQ === 'Р С›Р В»Р С‘Р Р†Р С‘Р Р… Р РЋР С‘РЎвЂљР С‘') $nameBuild = $nameBuildQ; 
  print $nameBuild;
  ?>.</span></b>
  <br>
  <div id="load">Р РЋР С•РЎРѓРЎвЂљР С•РЎРЏР Р…Р С‘Р Вµ: OK.</div>
  <div id="hrf">
  <a href='game.php?go=char&npc=1&do_npc=pc'>
    <- Р вЂ™Р ВµРЎР‚Р Р…РЎС“РЎвЂљРЎРЉРЎРѓРЎРЏ
  </a>
  </div>
</div>
<div id="fixedWindow" align="center" style="right:1px;">
  <b>
    <span align=center style="font-size:20;color:Black;">
      Р СџР С•Р С”Р ВµР СР С•Р Р…РЎвЂ№ РЎРѓ РЎРѓР С•Р В±Р С•Р в„–(<span id="coolpok"><?php print $cool_poke;?></span>):
   </span>
  </b>
  <br>
