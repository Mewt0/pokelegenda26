...
if(!empty($_GET['npc']) AND ($_GET['npc'] == 1 OR $_GET['npc']==2 OR $_GET['npc']==3))
  ...
  {
    $name = 'Р вЂ”Р С•Р Р…Р В° Р С’Р Т‘Р СР С‘Р Р…Р С‘РЎРѓРЎвЂљРЎР‚Р В°РЎвЂљР С•РЎР‚Р С•Р Р†';
    $about = 'Р С›_Р С• Р вЂ™РЎвЂ№ Р Р† Р В·Р С•Р Р…Р Вµ Р В°Р Т‘Р СР С‘Р Р…Р С‘РЎРѓРЎвЂљРЎР‚Р В°РЎвЂљР С•РЎР‚Р С•Р Р†.';
    $pers = "<a href='game.php?go=char&npc=3'>Р С™РЎС“РЎР‚Р В°РЎвЂљР С•РЎР‚</a> ";
    $move = '<a href="/game.php?go=char#" target="_chat_two">Р вЂ™ Р Р…Р С‘Р С”РЎС“Р Т‘Р В°...</a> ';
  }
