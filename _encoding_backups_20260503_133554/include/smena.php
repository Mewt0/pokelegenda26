  ...
  if($pokemon_new_atc['lvl'] < $new_atc['atc_lvl']) die("<script>location.href='game.php?go=pokemon';</script>");
      ...
      if(!$a){
         insert('attac_my_poke',array(
          ...
          if($a['a_id'] == $new || $a['b_id'] == $new || $a['c_id'] == $new || $a['d_id'] == $new)  die("<script>alert('Р вЂќР В°Р Р…Р Р…Р В°РЎРЏ Р В°РЎвЂљР В°Р С”Р В° РЎС“Р В¶Р Вµ РЎРѓРЎС“РЎвЂ°Р ВµРЎРѓРЎвЂљР Р†РЎС“Р ВµРЎвЂљ РЎС“ РЎРЊРЎвЂљР С•Р С–Р С• Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°.');location.href='game.php?go=pokemon';</script>"); 
          update('attac_my_poke',array($ac=>$new, $bc=>$pp, $dc=>$pp),'pok_id='.(int)$pok);
          if($a[$ac] != 0) die("<script>alert('Р С’РЎвЂљР В°Р С”Р В° РЎС“РЎРѓР С—Р ВµРЎв‚¬Р Р…Р С• Р С‘Р В·Р СР ВµР Р…Р ВµР Р…Р В°.');location.href='game.php?go=pokemon';</script>");
      }
  die("<script>alert('Р С’РЎвЂљР В°Р С”Р В° РЎС“РЎРѓР С—Р ВµРЎв‚¬Р Р…Р С• Р С‘Р В·РЎС“РЎвЂЎР ВµР Р…Р В°.');location.href='game.php?go=pokemon';</script>");
}
?>