...
<script>
function upSends(id){
if($("#send-"+id+" .sendsStatus").html() == "Р СњР Вµ Р С—РЎР‚Р С•РЎвЂЎР С‘РЎвЂљР В°Р Р…Р С•"){
...
function effectSlow(sub,id){
  ...
  if($("#send-"+id+" .sendsStatus").html() == "Р СњР Вµ Р С—РЎР‚Р С•РЎвЂЎР С‘РЎвЂљР В°Р Р…Р С•") upSends(id);
  return false;
}
function otvet(id){                           
...
function autoload(st,txt){
  if(st == 1) $("#cert").html('<img src="/css/img/load.gif" alt="Р вЂ”Р В°Р С–РЎР‚РЎС“Р В·Р С”Р В°" border="0"/>');
  else $("#cert").html(txt);
}
function sendGo(id){
 autoload(1,'-');
...
$("#cert").html('<img src="/css/img/load.gif" alt="Р вЂ”Р В°Р С–РЎР‚РЎС“Р В·Р С”Р В°" border="0"/>');
...
<div align="center">
<div style="color:#000"><b> Р РЋР С•РЎРѓРЎвЂљР С•РЎРЏР Р…Р С‘Р Вµ: <span id='cert' style="color:gold;"></span>.</b>
<br>
</div>
<div id='sends'>
</div>
