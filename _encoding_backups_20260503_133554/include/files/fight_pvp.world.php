...
<div id="BattleRoom">
    ...
    ?>  
		  ...
		  <div style="width:100%; text-align: left; height:14; border: 2px solid black; border-radius: 4px;"><div style='width:<?php echo $h1?>%;background:<?php echo $color1?>height:14;  border-radius: 4px;' title="Р С™Р С•Р В»Р С‘РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С• Р В·Р Т‘Р С•РЎР‚Р С•Р Р†РЎРЉРЎРЏ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°">
          <font style='font:11px Tahoma; color: #1C1C1C;'>
		  ...
		  <a class="tooltip" href="#">Р Р€РЎРѓР С‘Р В»Р ВµР Р…Р С‘РЎРЏ<span class="classic"> <?php
