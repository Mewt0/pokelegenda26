...
// Р СџРЎР‚Р С•Р Р†Р ВµРЎР‚Р С”Р С‘
  if($myrow['buildmy'] == 44){
    if(!provitems(69,1)){
...
// Р Р€Р Т‘Р С•РЎвЂЎР С”Р С‘...
if($build['tipe'] > 0){
 //Р РЋРЎвЂљР В°РЎР‚Р В°РЎРЏ РЎС“Р Т‘Р С•РЎвЂЎР С”Р В°
  if(provitems(16,1)){
...
if($myLocPokemon >= 2000000000){
  $t = "Р СњР В°: ".$_SESSION['login']."(".$_SESSION['id']."), РЎС“Р Т‘Р В°РЎвЂЎР Р…Р С• РЎРѓРЎР‚Р В°Р В±Р С•РЎвЂљР В°Р В» Р С—РЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ Р С‘ Р ВµР С–Р С• Р С—Р ВµРЎР‚Р ВµР С”Р С‘Р Р…РЎС“Р В»Р С• Р Р…Р В° Р В»Р С•Р С”Р В°РЎвЂ Р С‘РЎР‹ РЎРѓ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°Р СР С‘: ".$myLocPokemon;        
...
if(($myrow['atack_poke'] <= time()) && $myrow['pvp'] == 0 && $myrow['pve'] == 0 && $myrow['pve_button'] == 1 && $build['pve'] > 0 && $pokemHp['countpok'] <= 0)
  print "parent.mess_error('Р вЂ™Р В°РЎв‚¬Р С‘ Р С—Р С•Р С”Р ВµР СР С•Р Р…РЎвЂ№ РЎРѓР В»Р С‘РЎв‚¬Р С”Р С•Р С РЎРѓР В»Р В°Р В±РЎвЂ№, РЎвЂЎРЎвЂљР С• Р В±РЎвЂ№ Р Р…Р В°РЎвЂЎР В°РЎвЂљРЎРЉ Р В±Р С•Р в„–. Р СџР С•Р В¶Р В°Р В»РЎС“Р в„–РЎРѓРЎвЂљР В°, Р С•Р В±РЎР‚Р В°РЎвЂљР С‘РЎвЂљР ВµРЎРѓРЎРЉ Р Р† Р С—Р С•Р С”Р ВµРЎвЂ Р ВµР Р…РЎвЂљРЎР‚ Р С” РЎРѓР ВµРЎРѓРЎвЂљРЎР‚Р Вµ Р вЂќР В¶Р С•Р в„–. Р С›Р Р…Р В° Р С—Р С•Р В»Р Р…Р С•РЎРѓРЎвЂљРЎРЉРЎР‹ Р Р†Р С•РЎРѓРЎРѓРЎвЂљР В°Р Р…Р С•Р Р†Р С‘РЎвЂљ РЎРѓР С‘Р В»РЎвЂ№ Р Р†Р В°РЎв‚¬Р С‘РЎвЂ¦ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р С•Р Р† Р С‘ Р Р†РЎвЂ№ РЎРѓР СР С•Р В¶Р ВµРЎвЂљР Вµ Р С—РЎР‚Р С•Р Т‘Р С•Р В»Р В¶Р С‘РЎвЂљРЎРЉ РЎРѓР Р†Р С•Р в„– Р С—РЎС“РЎвЂљРЎРЉ.','block');";
...
/** Р РЋР С•Р С•Р В±РЎвЂ°Р ВµР Р…Р С‘РЎРЏ РЎвЂЎР В°РЎвЂљР В° **/ 
  if($myrow['mychat']==1){ 
