...
<head>
    ...
    <title>Р РЋР С—Р С‘РЎРѓР С•Р С” Р С”Р Р†Р ВµРЎРѓРЎвЂљР С•Р Р†</title>
...
<body>
    <div class="quest-container">
        <div class="quest-header">
            <h1><i class="fas fa-tasks"></i> Р вЂ™Р В°РЎв‚¬Р С‘ Р С”Р Р†Р ВµРЎРѓРЎвЂљРЎвЂ№</h1>
        </div>
        ...
        if(empty($q_my)): ?>
            <div class="no-quests">
                ...
                <p>Р вЂ™ Р Т‘Р В°Р Р…Р Р…РЎвЂ№Р в„– Р СР С•Р СР ВµР Р…РЎвЂљ РЎС“ Р Р†Р В°РЎРѓ Р Р…Р ВµРЎвЂљ Р В°Р С”РЎвЂљР С‘Р Р†Р Р…РЎвЂ№РЎвЂ¦ Р С”Р Р†Р ВµРЎРѓРЎвЂљР С•Р Р†.</p>
                <p>Р СџР С•РЎРѓР ВµРЎвЂљР С‘РЎвЂљР Вµ Р Т‘Р С•РЎРѓР С”РЎС“ Р В·Р В°Р Т‘Р В°Р Р…Р С‘Р в„–, РЎвЂЎРЎвЂљР С•Р В±РЎвЂ№ Р С—Р С•Р В»РЎС“РЎвЂЎР С‘РЎвЂљРЎРЉ Р Р…Р С•Р Р†РЎвЂ№Р в„– Р С”Р Р†Р ВµРЎРѓРЎвЂљ!</p>
            </div>
        <?php endif; 
        ...
        if(!empty($q_my)):
            foreach($q_my as $q_my_f):
                ...
                // Р С›Р С—РЎР‚Р ВµР Т‘Р ВµР В»Р ВµР Р…Р С‘Р Вµ РЎвЂ Р Р†Р ВµРЎвЂљР В° Р С—РЎР‚Р С•Р С–РЎР‚Р ВµРЎРѓРЎРѓ-Р В±Р В°РЎР‚Р В°
                ...
                <div class="quest-item">
                    ...
                    <div id="quest_hide<?php echo $ps; ?>" class="quest-content">
                        ...
                        <div class="quest-task-header">
                            ...
                            <span><?=($q_my_f['gotov']>0?'Р СњР В°Р С–РЎР‚Р В°Р Т‘Р В°':'Р вЂ”Р В°Р Т‘Р В°РЎвЂЎР В°');?></span>
                        </div>
                            ...
                            ?>
                                        <div class="pokemon-task">
                                            <div class="pokemon-image">
                                                <img src="pok/anim/<?php echo $bid.'.'.$format; ?>" alt="Р СџР С•Р С”Р ВµР СР С•Р Р… #<?php echo $bid; ?>">
                                            </div>
                                            <div class="pokemon-info">
                                                <b>Р СџР С•Р В±Р ВµР В¶Р Т‘Р ВµР Р…Р С• Р С—Р С•Р С”Р ВµР СР С•Р Р…Р С•Р Р† #<?php echo $bid; ?>: 
                                                <span style="color:#FF6347;"><?php echo $pqprow['coolpokemin']; ?></span> 
                                                Р С‘Р В· <span style="color:#7CFC00;"><?php echo $pqprow['coolpokemax']; ?></span></b>
                                            </div>
                                        </div>
                            <?php 
                                    endforeach;
                        ...
                        <div class="progress-toggle" id="quest_clicker_menu<?php echo $ps; ?>">
                            ...
                            <span class="progress-toggle-text">Р СџР С•Р С”Р В°Р В·Р В°РЎвЂљРЎРЉ Р С—РЎР‚Р С•Р С–РЎР‚Р ВµРЎРѓРЎРѓ</span>
                        </div>
