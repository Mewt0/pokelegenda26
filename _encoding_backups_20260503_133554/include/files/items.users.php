...
<HTML>
<HEAD>
<TITLE>League-Of-Pokemons -> Р СљР С•Р в„– Р С‘Р Р…Р Р†Р ВµР Р…РЎвЂљР В°РЎР‚РЎРЉ</TITLE>
...
<?php
if($itemsCount['count'] <= 0) die('<h1>Р СњР В° Р Т‘Р В°Р Р…Р Р…РЎвЂ№Р в„– Р СР С•Р СР ВµР Р…РЎвЂљ РЎС“ Р Р†Р В°РЎРѓ Р Р…Р ВµРЎвЂљРЎС“ Р Р…Р С‘РЎвЂЎР ВµР С–Р С• Р С‘Р В· Р С‘Р Р…Р Р†Р ВµР Р…РЎвЂљР В°РЎР‚РЎРЏ.<h1>');
?>
...
<h2>Р ВР Р…Р Р†Р ВµР Р…РЎвЂљР В°РЎР‚РЎРЉ</h2> 
<b><center><a href="game.php?go=eggs">Р вЂ™ Р С‘Р Р…Р С”РЎС“Р В±Р В°РЎвЂљР С•РЎР‚Р Р…РЎС“РЎР‹ Р С”Р В°Р СР ВµРЎР‚РЎС“</a> </center></b>
<div id="divTip"></div>
...
<form action="game.php?go=items" method="post" id="formit">
    ...
    <td align="center">
      <table>
       <tr>
        ...
        <td>
          <input name="but0" type="button" value="Р вЂ™РЎвЂ№Р В±РЎР‚Р С•РЎРѓР С‘РЎвЂљРЎРЉ" onclick="if (document.getElementById('formit')['amount'].value > 0) { if (confirm('Р вЂ™РЎвЂ№ РЎвЂљР С•РЎвЂЎР Р…Р С• РЎвЂ¦Р С•РЎвЂљР С‘РЎвЂљР Вµ Р Р†РЎвЂ№Р В±РЎР‚Р С•РЎРѓР С‘РЎвЂљРЎРЉ РЎРЊРЎвЂљР С•РЎвЂљ Р С—РЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ?')) use_item('drop');}">
        </td>
       </tr>
       <tr>
        <td>
        ...
        <td>
          <input name="but01" type="button" value="Р С›РЎвЂљР Т‘Р В°РЎвЂљРЎРЉ Р С”Р В»Р В°Р Р…РЎС“" onclick="if (document.getElementById('formit')['amount2'].value > 0) { if (confirm('Р вЂ™РЎвЂ№ РЎвЂљР С•РЎвЂЎР Р…Р С• РЎвЂ¦Р С•РЎвЂљР С‘РЎвЂљР Вµ Р С•РЎвЂљР Т‘Р В°РЎвЂљРЎРЉ РЎРЊРЎвЂљР С•РЎвЂљ Р С—РЎР‚Р ВµР Т‘Р СР ВµРЎвЂљ Р Р† Р С”Р В»Р В°Р Р…?')) use_item('clan');}"> 
        </td>
       </tr>
      </table>
    </TD>
  ...
  <tr>
    <td valign="top" align="center"> 
      <input name="but1" style='display:none' type="button" value="Р ВРЎРѓР С—Р С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљРЎРЉ" onclick="use_item('use');">  
      <input name="but2" style='display:none' type="button" value="Р С›Р Т‘Р ВµРЎвЂљРЎРЉ" onclick="use_item('dress');">
      <input name="but3" style='display:none' type="button" value="Р С›РЎвЂљР С”РЎР‚РЎвЂ№РЎвЂљРЎРЉ" onclick="use_item('use');"> 
