...
$data = $itemsinpage->SmartyArr();
  print '<table width="335" style="font-weight:bold; font-size:12px;">
            <tr>
              <td align="center" >
                <small><a href="javascript:" onclick="loadItems(1);">Р С›Р В±Р Р…Р С•Р Р†Р С‘РЎвЂљРЎРЉ</a></small>
              <td>
            </tr>
      	   <tr>
...
<HTML>
<HEAD>
<TITLE>League-Of-Pokemons -> Р ВР Р…Р С”РЎС“Р В±Р В°РЎвЂљР С•РЎР‚Р Р…Р В°РЎРЏ Р С”Р В°Р СР ВµРЎР‚Р В°</TITLE>
     ...
     if(!empty($eggs_atk)){ 
      if(!empty($_POST['atc'])){
        ...
        if(!empty($b['id'])){
          ...
          die("<script>alert('Р С’РЎвЂљР В°РЎвЂљР С”Р В° РЎС“РЎРѓР С—Р ВµРЎв‚¬Р Р…Р С• Р Р†РЎвЂ№РЎС“РЎвЂЎР ВµР Р…Р В°.');window.close();</script>");
        }else{
          print '<b style="color:#000;padding:5px;">ERROR ATTAK POST!</b>';
        }
      }
      print '<center><h2>Р ВР В·РЎС“Р ВµР Р…Р С‘Р Вµ Р В°РЎвЂљР В°Р С” Р Т‘Р В»РЎРЏ РЎРЏР в„–РЎвЂ Р В°: #'.$eggIsset['title'].' (ID: '.$eggGet.').<br>Р вЂР В°Р В·Р С•Р Р†РЎвЂ№Р в„– Р Р…Р С•Р СР ВµРЎР‚ РЎРЏР в„–РЎвЂ Р В°: #'.$eggIsset['base_id_egg'].'.</h2></center>';
      print '<font color="gold"><b>* Р ВР В·РЎС“РЎвЂЎР С‘РЎвЂљРЎРЉ Р СР С•Р В¶Р Р…Р С• РЎвЂљР С•Р В»РЎРЉР С”Р С• Р С•Р Т‘Р Р…РЎС“ Р В°РЎвЂљР В°Р С”РЎС“, Р С—Р ВµРЎР‚Р ВµРЎС“РЎвЂЎР С‘РЎвЂљРЎРЉ Р В°РЎвЂљР В°Р С”РЎС“ Р Р…Р ВµР В»РЎРЉР В·РЎРЏ.</b></font>';
      print '<table style="padding: 5px; margin: 15px;"> 
              <form action="" method="post" >
              <tr>
                <td colspan=2>
                  <b style="color:#000;padding:5px;">Р вЂ™РЎвЂ№Р В±Р С‘РЎР‚Р С‘РЎвЂљР Вµ Р В°РЎвЂљР В°Р С”РЎС“:</b>
                </td>
              </tr>';
      ...
      print '<tr><td colspan=2><b><input name="submit" type="submit" value="Р ВР В·РЎС“РЎвЂЎР С‘РЎвЂљРЎРЉ"> </b></td></tr></form></table>';
     }else{
      print '<b style="color:#000;padding:5px;">Р вЂќР В°Р Р…Р Р…РЎвЂ№Р в„– Р С—Р С•Р С”Р ВµР СР С•Р Р… Р Р…Р Вµ Р СР С•Р В¶Р ВµРЎвЂљ Р С‘Р В·РЎС“РЎвЂЎР В°РЎвЂљРЎРЉ РЎРЏР в„–РЎвЂ Р ВµР Р†РЎвЂ№Р Вµ Р В°РЎвЂљР В°Р С”Р С‘!</b>';
     }
   }else{
      print '<b style="color:#000;padding:5px;">Р Р€ РЎРЏР в„–РЎвЂ Р В°: #'.$eggIsset['title'].', РЎРЏР в„–РЎвЂ Р ВµР Р†Р В°РЎРЏ Р В°РЎвЂљР В°Р С”Р В° РЎС“Р В¶Р Вµ Р В±РЎвЂ№Р В»Р В° Р С‘Р В·РЎС“РЎвЂЎР ВµР Р…Р В°!</b>';
   }
 }else{
...
if($eggCount['count'] <= 0) die('<h2>Р СњР В° Р Т‘Р В°Р Р…Р Р…РЎвЂ№Р в„– Р СР С•Р СР ВµР Р…РЎвЂљ Р вЂ™Р В°РЎв‚¬Р В° Р С‘Р Р…Р С”РЎС“Р В±Р В°РЎвЂљР С•РЎР‚Р Р…Р В°РЎРЏ Р С”Р В°Р СР ВµРЎР‚Р В° Р С—РЎС“РЎРѓРЎвЂљР В°!<h2>');
?>
...
<h2>Р ВР Р…Р С”РЎС“Р В±Р В°РЎвЂљР С•РЎР‚Р Р…Р В°РЎРЏ Р С”Р В°Р СР ВµРЎР‚Р В°</h2> 
<b><center><a href="game.php?go=items">Р вЂ™ Р С‘Р Р…Р Р†Р ВµР Р…РЎвЂљР В°РЎР‚РЎРЉ</a> </center></b>
<div id="divTip"></div>
      ...
      <table>
       <tr>
        <td>
          ...
          <input name="but0" type="button" value="Р ВР В·РЎС“РЎвЂЎР С‘РЎвЂљРЎРЉ Р В°РЎвЂљР В°Р С”РЎС“" onclick="if (document.getElementById('formit')['attak'].value == 0 && document.getElementById('formit')['eggID'].value > 0) {  useAttak(document.getElementById('formit')['eggID'].value); }">
        </td>
       </tr>
      </table>
    </TD>
