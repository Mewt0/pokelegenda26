...
<h2>
Р СџРЎР‚Р С‘Р Р†Р ВµРЎвЂљРЎРѓРЎвЂљР Р†РЎС“Р ВµР С Р вЂ™Р В°РЎРѓ, РЎвЂљРЎР‚Р ВµР Р…Р ВµРЎР‚:    <?php print $_SESSION['login'];?>! 
</h2>
<table width=100% style="position: relative;">
 <tr>                                                             
  <td width=220 valign=top align=center>
	  <img alt='Р С’Р Р†Р В°РЎвЂљР В°РЎР‚: <? echo $_SESSION['login'];?>' src='img/ava/<? echo $ava;?>.png' class = 'avatarUsers' width='215' height='410'>
  </td>
  <td valign=top style='font-size:14px;position: relative;'>
   ...
   ?> 
    <div class="events" id="events">
     <div id="exit" class="exit" onclick="window.document.getElementById('events').style.display='none';">[Р вЂ”Р В°Р С”РЎР‚РЎвЂ№РЎвЂљРЎРЉ]</div>
      <span class="spans">Р вЂўР В¶Р ВµР Т‘Р Р…Р ВµР Р†Р Р…РЎвЂ№Р в„– Р В±Р С•Р Р…РЎС“РЎРѓ ^_^</span>
     <br>
      <div align="left" class="dayEvent">
       <span class="days">Р вЂќР ВµР Р…РЎРЉ:</span> 
      ...
      <br>
      <div class="eventitem">
        <span class="spans" style="font-size:25px;">Р РЋР ВµР С–Р С•Р Т‘Р Р…РЎРЏ Р вЂ™РЎвЂ№ Р С—Р С•Р В»РЎС“РЎвЂЎР В°Р ВµРЎвЂљР Вµ: </span> <br>
        <?php
        ...
        <table width=350>
          ...
          <tr>
            <td colspan='3' style='text-align:center; font-size:15px; color: #000; font-weight:bold;'>
              Р вЂ™Р С’Р РЃ Р РЋР СћР С’Р В Р СћР С›Р вЂ™Р В«Р в„ў Р СџР С›Р С™Р вЂўР СљР С›Р Сњ:
            </td>
          </tr>
          <tr>
          ...
          <?php
              ...
              print '<tr><td align="center"><center><b style="font-size:18px;color:#000;text-align:center">Р Р€ Р Р†Р В°РЎРѓ Р Р…Р ВµРЎвЂљ РЎРѓРЎвЂљР В°РЎР‚РЎвЂљР С•Р Р†Р С•Р С–Р С• Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°.</b></center></td></tr>';
            }
          ?>
        </table>
    </td>
