...
$commissionMarketRepository = new CommissionMarketRepository($db, $inventory);
$eggRepository = new EggRepository($db);
$breedingRepository = new BreedingRepository($db, $inventory);
...
$battleEngine = new BattleEngineService($battleRepository, $rewardRepository, $bossRepository);
