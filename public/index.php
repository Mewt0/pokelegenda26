...
$battleEngine = new BattleEngineService($battleRepository, $rewardRepository, $bossRepository, $safeStorage);
...
$adminApi = new AdminApiController($session, $csrf, $adminRepository, $bossRepository);
