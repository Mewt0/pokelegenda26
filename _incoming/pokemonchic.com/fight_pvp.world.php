...
$РЎРѓompulsionone = $battlPve['zamtru_1'];
$РЎРѓompulsiontwo = $battlPve['zamtru_2'];
...
// Р В®Р В·Р В°Р ВµР С Р В±Р В°РЎвЂљР В»
...
// Р РЋР СР ВµР Р…Р В° Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В° ************************************************************************************************************    
...
// Р РЋР СР ВµР Р…Р В° Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В° *****Р С™Р С›Р СњР вЂўР В¦******************************************************************************


// Р СџР С•Р В±Р ВµР Т‘РЎвЂ№ *********************************************************************************************
if($usersbattlone == $_SESSION['id'] AND $pobeda == 1){
  ...
  query('UPDATE users SET rang_a=rang_a+1, rang_b=rang_b-2  WHERE id=%d',$usersbattltwo);
   ...
   $text_log = "<b>Р СџР С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЉ: ".$_SESSION['login'].", <br> Р вЂ™РЎвЂ№Р С‘Р С–РЎР‚Р В°Р В» Р В±Р С•Р в„– РЎС“: ".users($usersbattltwo,'login')."</b>";
    ...
    $my_pokes_yes .= "<b><font color='brown'>Р СџР С•Р В±Р ВµР Т‘Р В° Р В·Р В° Р Р†Р В°Р СР С‘!</font></b><br>";
    $my_pokes_yes .= '<INPUT type="button" title="Р Р€Р в„–РЎвЂљР С‘" value="Р Р€Р в„–РЎвЂљР С‘" onclick="location.href=\'/game.php?go=char\';" style="width:120px;" > ';
...
if($usersbattltwo == $_SESSION['id'] AND $pobeda == 2){
  ...
  query('UPDATE users SET rang_a=rang_a+1, rang_b=rang_b-2 WHERE id=%d',$usersbattlone);
   $text_log = "<b>Р СџР С•Р В»РЎРЉР В·Р С•Р Р†Р В°РЎвЂљР ВµР В»РЎРЉ: ".$_SESSION['login'].", <br> Р вЂ™РЎвЂ№Р С‘Р С–РЎР‚Р В°Р В» Р В±Р С•Р в„– РЎС“: ".users($usersbattlone,'login')."</b>";
         writeLoges($text_log,'battle',$_SESSION['id']);
      if(!$clan_user2 OR !$clan_user1){ 
       // not...  
      }else {
...
// Р СџР С•Р В±Р ВµР Т‘РЎвЂ№ *Р С”Р С•Р Р…Р ВµРЎвЂ *    

// Р вЂўРЎРѓР В»Р С‘ Р С•Р С”Р С•Р Р…РЎвЂЎР ВµР Р… РЎвЂљР В°Р в„–Р С-Р В°РЎС“РЎвЂљ Р Р…Р В°РЎвЂЎР С‘РЎРѓР В»РЎРЏР ВµР С Р С—Р С•Р В±Р ВµР Т‘РЎС“ Р Р…РЎС“Р В¶Р Р…Р С•Р СРЎС“ РЎР‹Р В·Р ВµРЎР‚РЎС“ 
...
// Р вЂўРЎРѓР В»Р С‘ Р С•Р С”Р С•Р Р…РЎвЂЎР ВµР Р… РЎвЂљР В°Р в„–Р С-Р В°РЎС“РЎвЂљ Р Р…Р В°РЎвЂЎР С‘РЎРѓР В»РЎРЏР ВµР С Р С—Р С•Р В±Р ВµР Т‘РЎС“ Р Р…РЎС“Р В¶Р Р…Р С•Р СРЎС“ РЎР‹Р В·Р ВµРЎР‚РЎС“ *Р С”Р С•Р Р…Р ВµРЎвЂ *

// Р С’Р С—Р Т‘Р ВµР в„–РЎвЂљ Р С”Р С•Р С–Р Т‘Р В° Р С•Р В±Р В° Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В° Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…РЎвЂ№
if($pokeTwo != false AND $pokeOne != false AND $hodUsers != 3) 
      update('battles',array('hod_user_id'=>3),'id='.(int)$pve_id); 
// Р С’Р С—Р Т‘Р ВµР в„–РЎвЂљ Р С”Р С•Р С–Р Т‘Р В° Р С•Р В±Р В° Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В° Р Р†РЎвЂ№Р В±РЎР‚Р В°Р Р…РЎвЂ№ *Р С”Р С•Р Р…Р ВµРЎвЂ *  

if($usersbattlone == $_SESSION['id'] && ($hodUsers == 1 || $hodUsers == 2)){
  $timer_off = $time_2;
  $timer_off = $timer_off - time();
  $tt = "Р СћР В°Р в„–Р С: $timer_off РЎРѓР ВµР С”.";
  ...
  if($pokeOne == false){
     $hp_one_user_poke = select('SELECT id,names,lvl FROM pok_user WHERE users=%d AND active=1 AND hp_my > 0',$_SESSION['id']);
      if($hp_one_user_poke){
          $my_pokes_yes .= "<b><font color='brown'>Р вЂ™РЎвЂ№Р В±Р ВµРЎР‚Р ВµРЎвЂљР Вµ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В° Р Т‘Р В»РЎРЏ Р С—РЎР‚Р С•Р Т‘Р С•Р В»Р В¶Р ВµР Р…Р С‘РЎРЏ:</font></b>";
          $my_pokes_yes .= "<td>";
          ...
          $my_pokes_yes    .= "<input type='submit' name='submit' value='Р вЂ™РЎвЂ№Р В±РЎР‚Р В°РЎвЂљРЎРЉ'> </form></td>";
      }else{
          $my_pokes_yes    .= "<b><h1>Р СџР С•РЎР‚Р В°Р В¶Р ВµР Р…Р С‘Р Вµ!</h1></b>";
          update('battles',array('pobeda'=>2),'id='.(int)$pve_id); 
      }
  }else{
    $my_pokes_yes .= "<b><font color='brown'>Р С›Р В¶Р С‘Р Т‘Р В°Р ВµР С Р С•РЎвЂљР Р†Р ВµРЎвЂљ РЎРѓР С•Р С—Р ВµРЎР‚Р Р…Р С‘Р С”Р В°...</font></b><br>".$tt."<br>";
    $my_pokes_yes .= '<INPUT type="button" title="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" value="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" onclick="location.href=\'/game.php?go=fight_pvp&udar=sur\';" style="width:120px;" > ';
  }    
    echo '
    <LINK REL = "Stylesheet" HREF = "/css/battle.css" TYPE = "text/css">
...
if(!empty($_GET['atk']) && (($_GET['atk'] == 1) OR ($_GET['atk'] == 2) OR ($_GET['atk'] == 3) OR ($_GET['atk'] == 4))){
  if(poke_info($pokeTwo,'hp_my') > 0 && $usersbattltwo == $_SESSION['id'] && $РЎРѓompulsiontwo == 0) include('include/function/atk.php');
  if(poke_info($pokeOne,'hp_my') > 0 && $usersbattlone == $_SESSION['id'] && $РЎРѓompulsionone == 0) include('include/function/atk.php');
...
if (isset($_POST['itemgo'])){
  ...
  if($itemUser['item_id'] == 3) no_href_locs();
        if(($usersbattlone == $_SESSION['id']) && (poke_info($pokeOne,'hp_my') > 0) && $РЎРѓompulsionone == 0){
        ...
        if(($usersbattltwo == $_SESSION['id']) && (poke_info($pokeTwo,'hp_my') > 0) && $РЎРѓompulsiontwo == 0){
         if(provitems($itemUser['item_id'],1) && infoItems($itemUser['item_id'],'battleuse') == 1){
              $po_p = "998";
...
if($usersbattlone == $_SESSION['id']){
  ...
  $РЎРѓompulsion = $battlPve['zamtru_1'];
  $useText = 'user_1';
  $comText = 'zamtru_1';
  $pobeda    = 1;
  $pobedaNo  = 2;
  ...
  $РЎРѓompulsion = $battlPve['zamtru_2'];
  $useText = 'user_2';
  $comText = 'zamtru_2';
  $pobeda    = 2;
  $pobedaNo  = 1;
...
if($РЎРѓompulsion > 0){
 if($count_user_poke['countpok'] > 1){
   $okAtcFan = false;
   $textGoodsno = '<div id="atc" style="padding:10px;width:50%;text-align:center;font-weight:bold;cursor: default;"><table  align="center"><tr><td align="center" colspan=2> <b>Р СџРЎР‚Р С‘Р Р…РЎС“Р Т‘Р С‘РЎвЂљР ВµР В»РЎРЉР Р…Р В°РЎРЏ РЎРѓР СР ВµР Р…Р В° Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°.<br>Р вЂ™РЎвЂ№Р В±Р ВµРЎР‚Р С‘РЎвЂљР Вµ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°: </b><td></tr><tr>';
   if($hp_one_user_poke){
      ...
      $textGoodsno  .= "<input type='submit' name='submit' value='Р вЂ”Р В°Р СР ВµР Р…Р С‘РЎвЂљРЎРЉ'> </form></td>";
   }
   $textGoodsno .= '
     </tr>
     <tr>
      <td colspan=2 align="center">
        <INPUT type="button" title="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" value="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" onclick="window.location.href=\'/game.php?go=fight_pvp&udar=sur\';" style="width:120px;" >
      </td>
    </tr>
   </table></div>
   ';
  ...
  if($hp_my > 0){
    if($hp_no > 0){
      ...
      echo '<br><br><br>
      <font style="font-size: 19px;">Р С›Р В¶Р С‘Р Т‘Р В°Р ВµР С Р Р†РЎвЂ№Р В±Р С•РЎР‚ РЎРѓР С•Р С—Р ВµРЎР‚Р Р…Р С‘Р С”Р В°...</font>
      <br><br>
  ...
  $my_pokes_yes = "";
      ...
      foreach($hp_one_user_poke as $smena_pok_id){
        ...
        $out =  '<INPUT type="button" title="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" value="Р РЋР Т‘Р В°РЎвЂљРЎРЉРЎРѓРЎРЏ" onclick="location.href=\'/game.php?go=fight_pvp&udar=sur\';" style="width:120px;" >';
      }else{
...
<br><p><br><br>
          ...
          <?php echo "#".poke_info($pokem_two,'names'); ?> <?php echo poke_info($pokem_two,'lvl'); ?>  - lvl </div>
		  </b> <br>
		  <center><img id="pVs" src="pok/pok/<?php echo poke_info($pokem_two,'basenum'); ?>.gif"><br>
		  <div id="moves_two"></div>
		  <div style='width:<?php echo $h2?>%;background:<?php echo $color2?>height:14; border: 2px solid black; border-radius: 4px;' title="Р С™Р С•Р В»Р С‘РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С• Р В·Р Т‘Р С•РЎР‚Р С•Р Р†РЎРЉРЎРЏ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°">
    ...
    $acr_st_no_pl  = status_na_pokemone($pokem_two,$battlPve['id'],'plus','accuracy');
             if ($def_st_no_pl>0) echo "<b>Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° + ".$def_st_no_pl."</b> ";
             if ($sdef_st_no_pl>0)echo "<b>Р РЋР С—Р ВµРЎвЂ . Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° + ".$sdef_st_no_pl."</b> ";
             if ($atk_st_no_pl>0) echo "<b>Р С’РЎвЂљР В°Р С”Р В° + ".$atk_st_no_pl."</b> ";
             if ($satk_st_no_pl>0)echo "<b>Р РЋР С—Р ВµРЎвЂ . Р С’РЎвЂљР В°Р С”Р В° + ".$satk_st_no_pl."</b> ";
             if ($acc_st_no_pl>0) echo "<b>Р вЂєР С•Р Р†Р С”Р С•РЎРѓРЎвЂљРЎРЉ + ".$acc_st_no_pl."</b> ";
             if ($spd_st_no_pl>0) echo "<b>Р РЋР С”Р С•РЎР‚Р С•РЎРѓРЎвЂљРЎРЉ + ".$spd_st_no_pl."</b> ";
             if ($acr_st_no_pl>0) echo "<b>Р СћР С•РЎвЂЎР Р…Р С•РЎРѓРЎвЂљРЎРЉ + ".$acr_st_no_pl."</b> ";
    ...
    $acr_st_no_min  = status_na_pokemone($pokem_two,$battlPve['id'],'minus','accuracy');         
             if ($def_st_no_min>0) echo "<font color='".$color_stst."'><b>Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° - ".$def_st_no_min."</b></font> ";
             if ($sdef_st_no_min>0)echo "<font color='".$color_stst."'><b>Р РЋР С—Р ВµРЎвЂ . Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° - ".$sdef_st_no_min."</b></font> ";
             if ($atk_st_no_min>0) echo "<font color='".$color_stst."'><b>Р С’РЎвЂљР В°Р С”Р В° - ".$atk_st_no_min."</b></font> ";
             if ($satk_st_no_min>0)echo "<font color='".$color_stst."'><b>Р РЋР С—Р ВµРЎвЂ . Р С’РЎвЂљР В°Р С”Р В° - ".$satk_st_no_min."</b></font> ";
             if ($acc_st_no_min>0) echo "<font color='".$color_stst."'><b>Р вЂєР С•Р Р†Р С”Р С•РЎРѓРЎвЂљРЎРЉ - ".$acc_st_no_min."</b></font> ";
             if ($spd_st_no_min>0) echo "<font color='".$color_stst."'><b>Р РЋР С”Р С•РЎР‚Р С•РЎРѓРЎвЂљРЎРЉ - ".$spd_st_no_min."</b></font> ";
             if ($acr_st_no_min>0) echo "<font color='".$color_stst."'><b>Р СћР С•РЎвЂЎР Р…Р С•РЎРѓРЎвЂљРЎРЉ - ".$acr_st_no_min."</b></font> ";
    ...
    ?>  
          ...
          <?php echo "#".poke_info($pokem_one,'names'); ?> <?php echo poke_info($pokem_one,'lvl'); ?> - lvl </div>
		  </b> <br>
		  <center><img id="pMy" src="pok/back/<?php echo poke_info($pokem_one,'basenum'); ?>.gif">
		  <div id="moves_one"></div>
		  <div style='width:<?php echo $h1?>%;background:<?php echo $color1?>height:14;  border: 2px solid black; border-radius: 4px;' title="Р С™Р С•Р В»Р С‘РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С• Р В·Р Т‘Р С•РЎР‚Р С•Р Р†РЎРЉРЎРЏ Р С—Р С•Р С”Р ВµР СР С•Р Р…Р В°">
          <font style='font:11px Tahoma; color: #1C1C1C;'>
...
$acr_st_my_pl  = status_na_pokemone($pokem_one,$pve_id,'plus','accuracy');
         if ($def_st_my_pl >0) echo "<b>Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° + ".$def_st_my_pl."</b> ";
         if ($sdef_st_my_pl>0) echo "<b>Р РЋР С—Р ВµРЎвЂ . Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° + ".$sdef_st_my_pl."</b> ";
         if ($atk_st_my_pl >0) echo "<b>Р С’РЎвЂљР В°Р С”Р В° + ".$atk_st_my_pl."</b> ";
         if ($satk_st_my_pl>0) echo "<b>Р РЋР С—Р ВµРЎвЂ . Р С’РЎвЂљР В°Р С”Р В° + ".$satk_st_my_pl."</b> ";
         if ($acc_st_my_pl >0) echo "<b>Р вЂєР С•Р Р†Р С”Р С•РЎРѓРЎвЂљРЎРЉ + ".$acc_st_my_pl."</b> ";
         if ($spd_st_my_pl >0) echo "<b>Р РЋР С”Р С•РЎР‚Р С•РЎРѓРЎвЂљРЎРЉ + ".$spd_st_my_pl."</b> ";
         if ($acr_st_my_pl >0) echo "<b>Р СћР С•РЎвЂЎР Р…Р С•РЎРѓРЎвЂљРЎРЉ + ".$acr_st_my_pl."</b> ";
...
$acr_st_my_min  = status_na_pokemone($pokem_one,$pve_id,'minus','accuracy');         
         if ($def_st_my_min>0) echo "<font color='".$color_stst."'><b>Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° - ".$def_st_my_min."</b></font> ";
         if ($sdef_st_my_min>0)echo "<font color='".$color_stst."'><b>Р РЋР С—Р ВµРЎвЂ . Р вЂ”Р В°РЎвЂ°Р С‘РЎвЂљР В° - ".$sdef_st_my_min."</b></font> ";
         if ($atk_st_my_min>0) echo "<font color='".$color_stst."'><b>Р С’РЎвЂљР В°Р С”Р В° - ".$atk_st_my_min."</b></font> ";
         if ($satk_st_my_min>0)echo "<font color='".$color_stst."'><b>Р РЋР С—Р ВµРЎвЂ . Р С’РЎвЂљР В°Р С”Р В° - ".$satk_st_my_min."</b></font> ";
         if ($acc_st_my_min>0)echo  "<font color='".$color_stst."'><b>Р вЂєР С•Р Р†Р С”Р С•РЎРѓРЎвЂљРЎРЉ - ".$acc_st_my_min."</b></font> ";
         if ($spd_st_my_min>0)echo  "<font color='".$color_stst."'><b>Р РЋР С”Р С•РЎР‚Р С•РЎРѓРЎвЂљРЎРЉ - ".$spd_st_my_min."</b></font> ";
         if ($acr_st_my_min>0)echo  "<font color='".$color_stst."'><b>Р СћР С•РЎвЂЎР Р…Р С•РЎРѓРЎвЂљРЎРЉ - ".$acr_st_my_min."</b></font> ";
