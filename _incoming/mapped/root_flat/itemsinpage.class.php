...
class Itemsinpage{
	...
	function __construct($total){
		...
		$_GET['count'] = $this->inpage = (isset($_GET['count'])?max(1,(int)$_GET['count']):10);
		...
		$this->linkcount= 9; // Р Т‘Р С•Р В»Р В¶Р Р…Р С• Р В±РЎвЂ№РЎвЂљРЎРЉ Р Р…Р ВµРЎвЂЎР ВµРЎвЂљР Р…РЎвЂ№Р С!
