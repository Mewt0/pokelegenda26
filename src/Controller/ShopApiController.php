...
final class ShopApiController
{
    ...
    public function buyTrainingItem(Request $request): Response
    {
        ...
        return $this->json($this->training->buy(
            $userId,
            (string) $request->input('shop', 'market'),
