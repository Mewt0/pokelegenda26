<?php  
  if(!empty($_GET['npc']) && ($_GET['npc'] == 1 || $_GET['npc'] == 2)){
    ...
    $pers = '<a href="/game.php?go=char&npc=1&do_npc=pc">Покецентр</a> | <a href="/game.php?go=char&npc=2">Покемаркет</a> | <s>Рынок водных покемонов</s>';
    $move = '<a href="/game.php?go=charWork&loc=21" target="_chat_two">Мост</a> | 
             <s>Пляж</s> | <s>Цирк</s> |<a href="/game.php?go=charWork&loc=80" target="_chat_two">Стадион Электрических покемонов</a> | <a href="/game.php?go=charWork&loc=49" target="_chat_two">Дорога 5</a> | <a href="/game.php?go=charWork&loc=23" target="_chat_two">Порт Церулина</a>';
  }
?>
