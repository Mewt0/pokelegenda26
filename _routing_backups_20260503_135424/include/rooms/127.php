<?php  
  if(!empty($_GET['npc']) && ($_GET['npc'] == 1 || $_GET['npc'] == 2)){
    ...
    $name = 'Феларбор';
    $about = 'Вот Вы и пришли в самый красивый водный город Феларбор. 
    ...
    $move = '<a href="/game.php?go=charWork&loc=126" target="_chat_two">Дорога 113</a> | <a href="/game.php?go=charWork&loc=128" target="_chat_two">Дорога 114</a>';
  }
?>